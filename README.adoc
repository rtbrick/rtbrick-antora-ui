= Antora UI for RtBrick documentation
...
== Open Source Tools used by RtBrick Antora UI

Open source tools are kept under `src/vendor/`.
Antora Default UI does not have the folder. So, `vfs.src('vendor/**/*', opts)` was added in `build.js`.

=== ViewerJS

ViewerJS can be used to view presentations, spreadsheets, PDF's and other documents on site.

* Site: https://viewerjs.org
* Version: viewerjs-0.5.8
* License: AGPL-3.0
---
